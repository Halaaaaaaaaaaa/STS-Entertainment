			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link collapsed" href="a_performance_ent_t"
							data-bs-toggle="collapse" data-bs-target="#performancelist"
							aria-expanded="false" aria-controls="performancelist">
							<div class="sb-nav-link-icon">
						...
						<div class="collapse" id="performancelist"
							aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="a_performance_ent_t">전체</a> <a
									class="nav-link" href="a_performance_ent_f?category=1">콘서트</a>
						...
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
							data-bs-target="#bookinglist" aria-expanded="false"
						...
						<div class="collapse" id="bookinglist"
							aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="a_performance_booking_t">전체 예약 조회</a>
								<a class="nav-link" href="a_performance_booking_f?category=1">콘서트
									예약 조회</a> <a class="nav-link"
									href="a_performance_booking_f?category=2">연극 예약 조회</a> <a
									class="nav-link" href="a_performance_booking_f?category=3">전시회
									예약 조회</a>
							</nav>
						</div>
					</div>
					...
					<div class="nav">
						...
						<a class="nav-link" href="a_cs_main">
							<div class="sb-nav-link-icon">
								<i class="fas fa-tachometer-alt"></i>
							</div> 전체 문의 목록
						</a>
